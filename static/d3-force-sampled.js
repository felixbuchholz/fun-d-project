...
(function(global, factory) {
  ...
  function manyBodySampled() {
    ...
    function initialize() {
      ...
      numNeighbors =
        numNeighbors < 0 ? 0 : Math.min(numNeighbors, nodes.length);
    ...
    force.neighborSize = function(_) {
      return arguments.length
        ? ((neighborSize = typeof _ === "function" ? _ : constant(+_)),
          initialize(),
          force)
        : neighborSize;
    };
    ...
    force.updateSize = function(_) {
      return arguments.length
        ? ((updateSize = typeof _ === "function" ? _ : constant(+_)),
          initialize(),
          force)
        : updateSize;
    };
    ...
    force.sampleSize = function(_) {
      return arguments.length
        ? ((sampleSize = typeof _ === "function" ? _ : constant(+_)),
          initialize(),
          force)
        : sampleSize;
    };
