  ...
  <div class="scrolly-telling-text">
    <Scrollama @step-enter="stepEnterHandler">
      ...
      <div class="margin-scrollama-text" id='sroll_4'  >
         <p>We noticed a few shareholder proposals asking the target company to hire an advisor to maximize shareholder value. Most of this comes from "activist hedge funds" that buy a certain amount of stock in a company, to be able to enforce key changes at target companies. The goal of shareholder value maximization is not without controversy. It can conflict with other stakeholders’ interests, like when a reorganization seeks to dispose of many employees, with the purpose of realizing a short-term gain rather than improving the company. <br><br>
