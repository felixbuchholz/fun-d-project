  ...
  <div id="scrolly1" class="scrolly-telling-text">
    ...
    <Scrollama :offset="0.35" @step-enter="stepEnterHandler">
      ...
      <div id="scroll_6" :class="`margin-scrollama-text ${getLoadingState(6)}`">
        <fa icon="spinner" class="scrolly-step-indicator" />
        <p>
          We noticed a clear increase of shareholder activism addressing
          workplace diversity in the past years. The New York City Pension Fund
          has been pushing for a standardized disclosure of directors’ gender,
          race and skills. More and more shareholders seem unwilling to approve
          boards that fully lack diversity. <br /><br />
          In addition to shareholder activists, the largest proxy advisor (ISS)
          said recently in its
          <a
            href="https://www.issgovernance.com/file/policy/latest/updates/Executive-Summary-of-ISS-Policy-Updates-and-Process.pdf"
            target="_blank"
            >2020 vote guidelines</a
          >
          that it will not support board nominees at larger companies when there
          are no women on the company’s board. For the upcoming years, this
          trend is to continue. Also state legislation is playing a role:
          companies headquartered in the
          <a
            href="https://www.sos.ca.gov/business-programs/women-boards/"
            target="_blank"
      ...
      <div id="scroll_7" :class="`margin-scrollama-text ${getLoadingState(7)}`">
        <fa icon="spinner" class="scrolly-step-indicator" />
        <p>
          In 2016, more than 174 countries signed the UN Paris Agreement to
          strengthen the global response to climate change. They committed to
          keep a global temperature rise during this century below 2 degrees
          Celsius, compared to pre-industrial levels. <br /><br />
          Indeed, as of 2016 multiple shareholders submitted .
        </p>
      </div>
